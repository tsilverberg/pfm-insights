    ...
    <IonPage>
      <IonContent className="page-content">
        ...
        <div className="request-header">
          <div className="request-header__spacer" />
          <span className="request-header__title">Request money</span>
          <button className="request-header__close" onClick={() => history.goBack()}>
